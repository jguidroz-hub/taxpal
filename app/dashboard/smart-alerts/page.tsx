...
export default function FeaturePage() {
  const items = [
    { t: "🔴 High CPU usage sustained >15min", d: "Server: prod-api-1 • Current: 94% • Started: 12:05 PM • Auto-scaling triggered", s: "critical" },
    { t: "🟡 Response time degradation", d: "P95 latency: 2.3s (threshold: 2s) • Affected: /api/search • Since: 11:30 AM", s: "warning" },
    { t: "🟢 Deployment successful", d: "v2.14.3 deployed to production • All health checks passing • 0 errors", s: "info" },
    { t: "🔵 Weekly report ready", d: "Traffic up 12% • 0 downtime incidents • Top endpoint: /api/dashboard", s: "info" }
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <header className="bg-white border-b px-6 py-3 flex items-center gap-4">
        ...
        <h1 className="font-bold">Smart Alerts</h1>
      </header>
      <div className="max-w-4xl mx-auto px-6 py-8">
        <p className="text-gray-500 text-sm mb-6">Intelligent alerting with noise reduction</p>
